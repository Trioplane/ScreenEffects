...
$execute if data storage scrfx:running_screen_effects running."$(player_id)".middle.frame store result score @s scrfx.zinternals.player.middle_frame run data get storage scrfx:running_screen_effects running."$(player_id)".middle.frame
$execute if data storage scrfx:running_screen_effects running."$(player_id)".end.callback run scoreboard players set @s scrfx.zinternals.player.has_end_callback 1
scoreboard players operation @s scrfx.zinternals.player.title_time = @s scrfx.zinternals.player.tps
$execute store result storage scrfx:running_screen_effects running."$(player_id)".title_time int 1 run scoreboard players add @s scrfx.zinternals.player.title_time 2
